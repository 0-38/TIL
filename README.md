...
데이터 사이언티스트를 목표로 학습한 내용을 정리하는 TIL 저장소입니다.

Python을 기반으로 **데이터 분석, 통계, 머신러닝, SQL, 데이터베이스**를 학습하고 기록합니다.

단순히 코드를 사용하는 것보다 **왜 사용하는지, 어떻게 동작하는지, 결과를 어떻게 해석하는지** 이해하는 것을 목표로 합니다.
...
단순히 `Cost`만 확인하기보다 다음 항목을 함께 비교합니다.
...
생성형 AI를 학습과 데이터 분석에 활용하는 방법을 정리합니다.
...
> **각 폴더에서 학습한 주요 개념과 함수·문법을 한눈에 보여주기 위한 구조입니다.**
